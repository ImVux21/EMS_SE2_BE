...
public class HtmlMailVerifiedCreator {
    ...
    private static final String VUE_APP_FRONT_END_URL = "http://localhost:5173";

    public static String generateHTML(String fullname, String code) {
        logger.info("generateHTML");
        String link = VUE_APP_FRONT_END_URL + "/verify-email" + "/" + code;
        String html =
                "<!DOCTYPE html>" +
                        "<html>" +
                        "  <head>" +
                        ...
                        "                  <a href=\"" + VUE_APP_FRONT_END_URL + "/home\">EMS</a>, you can safely" +
                        "                  delete this email." +
                        "                </p>" +
                        "              </td>" +
                        "            </tr>" +
